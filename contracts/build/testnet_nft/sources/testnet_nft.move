module examples::testnet_nft {
    ...
    fun init(otw: TESTNET_NFT, ctx: &mut TxContext) {
        ...
        display::add(&mut display, string::utf8(b"thumbnail_url"), string::utf8(b"{thumbnail_url}"));
    ...
    /// Mint directly to the tx.origin (sender)
    ...
    /// Mint into an arbitrary recipient’s address
